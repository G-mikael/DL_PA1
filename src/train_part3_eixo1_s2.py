...
def train_eixo_1():
    ...
    print(f"Treinando Eixo 1 - DeepLab em: {device}")
    ...
    for epoch in range(1, epochs + 1):
        ...
        if mean_val_iou > best_val_iou:
            ...
            checkpoint_path = CHECKPOINT_DIR / "eixo1_deeplab_resnet18_seed2028.pth"
    ...
    log_data = {
        "step": "Parte 3 - Eixo 1 - DeepLab",
        "timestamp": time.strftime("%Y-%m-%d %H:%M:%S"),
        "architecture": "DeepLabV3Plus-ResNet18",
        "epochs": epochs,
        "batch_size": 16,
        "lr_initial": 1e-3,
    ...
    log_json_path = LOG_DIR / "eixo1_deeplab_history_seed2028.json"
    with open(log_json_path, "w", encoding="utf-8") as f:
        json.dump(log_data, f, indent=4, ensure_ascii=False)

    log_txt_path = LOG_DIR / "eixo1_deeplab_history_seed2028.txt"
    with open(log_txt_path, "w", encoding="utf-8") as f:
        f.write("=== LOG PARTE 3: TREINO EIXO 1 ===\n")
