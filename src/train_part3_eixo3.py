...
def train_eixo_3():
    ...
    print(f"Treinando Eixo 3 - PSPNet (ResNet-18) em: {device}")
    ...
    for epoch in range(1, epochs + 1):
        ...
        if mean_val_iou > best_val_iou:
            ...
            checkpoint_path = CHECKPOINT_DIR / "eixo3_pspnet_resnet18_seed2027.pth"
    ...
    log_data = {
        "step": "Parte 3 - Eixo 3 - Contexto Global",
        "timestamp": time.strftime("%Y-%m-%d %H:%M:%S"),
        "architecture": "PSPNet-ResNet18",
        "epochs": epochs,
        "batch_size": 16,
        "lr_initial": 1e-3,
    ...
    log_json_path = LOG_DIR / "eixo3_pspnet_history_seed2027.json"
    with open(log_json_path, "w", encoding="utf-8") as f:
        json.dump(log_data, f, indent=4, ensure_ascii=False)

    log_txt_path = LOG_DIR / "eixo3_pspnet_history_seed2027.txt"
    with open(log_txt_path, "w", encoding="utf-8") as f:
        f.write("=== LOG PARTE 3: TREINO EIXO 3 ===\n")
