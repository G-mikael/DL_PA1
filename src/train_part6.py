...
def train_trilha_a():
    ...
    train_ds = DSB2018Dataset(RAW_DIR, splits["fold_test_cluster_1"]["train"], transform=get_transforms("train"))
    val_ds   = DSB2018Dataset(RAW_DIR, splits["fold_test_cluster_1"]["val"], transform=get_transforms("val"))
