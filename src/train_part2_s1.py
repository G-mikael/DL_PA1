...
def train_trilha_a():
    ...
    for epoch in range(1, epochs + 1):
        ...
        if mean_val_iou > best_val_iou:
            ...
            checkpoint_path = CHECKPOINT_DIR / "trilha_a_unet_resnet18_seed2027.pth"
    ...
    log_json_path = LOG_DIR / "parte2_trilha_a_history_seed2027.json"
    with open(log_json_path, "w", encoding="utf-8") as f:
        json.dump(log_data, f, indent=4, ensure_ascii=False)

    log_txt_path = LOG_DIR / "parte2_trilha_a_history_seed2027.txt"
