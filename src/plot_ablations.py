...
# Agrupando as seeds
map_unet = [get_map("eval_unet_2027.json"), get_map("eval_unet_42.json")]
map_deeplab = [get_map("eval_deeplab_2027.json"), get_map("eval_deeplab_42.json")]
map_pspnet = [get_map("eval_pspnet_2027.json"), get_map("eval_pspnet_42.json")]
...
plt.savefig(LOG_DIR.parent / "reports" / "figures" / "ablations_comparison.png", dpi=300, bbox_inches='tight')
